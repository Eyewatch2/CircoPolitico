...
const DetailModal = ({ character, setIsModalOpen }) => {
  return (
    <div className='fixed w-full h-full z-50 bg-black/50'>
      <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-8/12 flex flex-col md:flex-row h-[90svh] bg-gradient-to-t from-white to-white/70 rounded-lg shadow-lg py-10 px-5 md:px-20'>
